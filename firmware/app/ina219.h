 ...
 */
typedef bool (*INA219_I2C_ReadFn)(void *user_ctx, uint8_t addr, uint8_t reg, uint8_t *buf, uint8_t len);
 ...
 * @return true on success, false on failure.
 */
typedef bool (*INA219_I2C_WriteFn)(void *user_ctx, uint8_t addr, uint8_t reg, uint8_t *buf, uint8_t len);
 ...
 */
#define INA219_CONFIG_DEFAULT ( (uint16_t)( \
    INA219_CFG_BRNG_32V | INA219_CFG_PG_320mV | \
 ...
 * @return ::INA219_OK on success.
 * @note Set the MODE bits in the CONFIG register to choose between continuous or triggered (single-shot) conversion.
 */
